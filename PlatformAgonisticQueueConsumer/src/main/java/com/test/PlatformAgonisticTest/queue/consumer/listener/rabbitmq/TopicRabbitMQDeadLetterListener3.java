...
@Component
public class TopicRabbitMQDeadLetterListener3 {

	@Autowired
	protected CommonQueueConsumerService consummerService;
	
	public TopicRabbitMQDeadLetterListener3() {
		super();
	}
	
	@RabbitListener(queues="subscriber3DeadLetterQueue")
	public void consumeMessage(TestData message) {
		String strVal = message.getStrVal();
		message.setStrVal(strVal + " - from subscriber 3 dead letter listenner");
